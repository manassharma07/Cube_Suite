...
if uploaded_file1 is not None and uploaded_file2 is not None:
    ...
    add_button = st.button("Add CUBE Files")

    if add_button:
        result = subprocess.run(["cube_tools", "-a", filepath1, filepath2], capture_output=True, text=True)
        if result.stderr:
            ...
            show_download_button(summed_file_content)
